...
This is a [follow-along](https://courses.calhoun.io/lessons/les_goph_85) I did to learn golang concurrency, caching and mutexes. All attempts are in `main.go` with the first attempts commented out.
